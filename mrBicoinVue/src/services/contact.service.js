...
function _createDefaultContacts() {
    return [
        _createContact("Ochoa Hyde", "ochoahyde@renovize.com", "+1 (968) 593-3824", 10),
        _createContact("Hallie Mclean", "halliemclean@renovize.com", "+1 (948) 464-2888", 73),
        _createContact("Parsons Norris", "parsonsnorris@renovize.com", "+1 (958) 502-3495", 100),
        _createContact("Rachel Lowe", "rachellowe@renovize.com", "+1 (911) 475-2312", 100),
    ]
}

function _createContact(name, email, phone, coins) {
    return {
        name, email, phone, coins
    }
